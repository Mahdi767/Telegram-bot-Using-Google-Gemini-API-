...
//
//    Make sure .env is in .gitignore to keep your keys safe.
//
// ----------------------------------------------------------------------
//
// Usage:
...
//    python bot.py
//
// Open Telegram and start chatting with your bot using /start.
//
// ----------------------------------------------------------------------
//
// Notes:
//
// - If Gemini is slow or the message is too long, the bot will reply:
//   "Oops! Gemini is taking a bit too long to reply. Try asking a shorter question — the API has some limits!"
// - The bot automatically handles questions about its creator in multiple languages.
//
// ----------------------------------------------------------------------
//
// License:
